...
problem
$$\hat{\boldsymbol{\beta}}=\underset{\boldsymbol{\beta}}{\arg\min}\left[\sum_{i=1}^{n}(y_{i}-\boldsymbol{x}_{i}^{\intercal}\boldsymbol{\beta})^{2}+\lambda\boldsymbol{\beta}^{\intercal}\boldsymbol{\beta}\right],\label{eq:ridgereg}$$
